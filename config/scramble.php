...
return [
    ...
    'api_path' => [
        'include' => '*',
        'exclude' => ['/', 'up', 'docs/*', '_scramble/*', 'sanctum/*', '_boost/*', 'storage/*'],
    ],
    ...
    'info' => [
         ...
         */
        'description' => 'Presensi API documentation. All endpoints use JSON envelopes shaped as {message, data} with optional {meta} for paginated responses.',
    ],
